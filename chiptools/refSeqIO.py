...
def parse_refseq_line(line):
    parts = line.split()
    _, isoform, chrom, strand, txStart, txEnd, cdsStart, cdsEnd, _, exonStarts, exonEnds, _, name, _, _, _ = line.split()
    ...
    return Anno(chrom, strand, txStart, txEnd, cdsStart, cdsEnd, exonStarts, exonEnds, name, isoform)
